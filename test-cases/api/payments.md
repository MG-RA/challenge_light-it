...
| Field | Value |
|---|---|
| Automated test | [payments.spec.ts:32](../../tests/api/payments.spec.ts:32) › `POST /payments stores one valid payment and rejects a duplicate` |
...
| Field | Value |
|---|---|
| Automated test | [payments.spec.ts:66](../../tests/api/payments.spec.ts:66) › `POST /payments rejects zero and negative amounts without storing a payment` |
| Project / tag | api / **@mutating** |
