...
| Field | Value |
|---|---|
| Automated test | [doctors.spec.ts:19](../../tests/api/doctors.spec.ts:19) › `Doctors API › GET /doctors satisfies the field-completeness policy` |
| Project / tag | api / — |
...
| Field | Value |
|---|---|
| Automated test | [doctors.spec.ts:28](../../tests/api/doctors.spec.ts:28) › `Doctors API › GET /doctors/:id matches the stored doctor` |
| Project / tag | api / — |
| Type | Functional, contract, data reconciliation |
...
| Field | Value |
|---|---|
| Automated test | [doctors.spec.ts:40](../../tests/api/doctors.spec.ts:40) › `Doctors API › GET /doctors/:id/availability returns valid clock slots` |
| Project / tag | api / — |
...
| Field | Value |
|---|---|
| Automated test | [doctors.spec.ts:53](../../tests/api/doctors.spec.ts:53) › `Doctors API › GET /doctors/:id returns 404 for an unknown doctor` |
| Project / tag | api / — |
