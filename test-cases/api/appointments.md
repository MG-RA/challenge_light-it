...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:21](../../tests/api/appointments.spec.ts:21) › `Appointments API › GET /appointments contains only the patient records and matches the DB` |
| Project / tag | api / — |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:45](../../tests/api/appointments.spec.ts:45) › `Appointments API › GET /appointments/:id returns an owned appointment matching the DB` |
| Project / tag | api / — |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:68](../../tests/api/appointments.spec.ts:68) › `Appointments API writes › POST /appointments stores exactly one owned appointment and detail agrees` |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:86](../../tests/api/appointments.spec.ts:86) › `Appointments API writes › PUT /appointments/:id/reschedule stores the new slot and preserves identity` |
| Project / tag | api / **@mutating** |
| Type | Functional, state verification |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:106](../../tests/api/appointments.spec.ts:106) › `Appointments API writes › PUT /appointments/:id/cancel stores the cancellation without touching a control` |
| Project / tag | api / **@mutating** |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:122](../../tests/api/appointments.spec.ts:122) › `Appointments API writes › DELETE /appointments/:id removes the row and detail returns 404` |
| Project / tag | api / **@mutating** |
| Type | Functional, state verification |
...
These cases are generated by the loop at [appointments.spec.ts:135](../../tests/api/appointments.spec.ts:135). They share these steps:
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:170](../../tests/api/appointments.spec.ts:170) › `Appointments API writes › POST /appointments rejects a duplicate slot and leaves exactly one booking` |
| Project / tag | api / **@mutating** |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:182](../../tests/api/appointments.spec.ts:182) › `Appointments API writes › PUT /appointments/:id/reschedule rejects an invalid body and stores no change` |
| Project / tag | api / **@mutating** |
