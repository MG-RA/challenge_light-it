...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:50](../../tests/api/appointments.spec.ts:50) › `Appointments API › GET /appointments/:id returns an owned appointment matching the DB` |
| Project / tag | api / — |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:75](../../tests/api/appointments.spec.ts:75) › `Appointments API writes › POST /appointments stores exactly one owned appointment and detail agrees` |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:93](../../tests/api/appointments.spec.ts:93) › `Appointments API writes › PUT /appointments/:id/reschedule stores the new slot and preserves identity` |
| Project / tag | api / **@mutating** |
| Type | Functional, state verification |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:113](../../tests/api/appointments.spec.ts:113) › `Appointments API writes › PUT /appointments/:id/cancel stores the cancellation without touching a control` |
| Project / tag | api / **@mutating** |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:129](../../tests/api/appointments.spec.ts:129) › `Appointments API writes › DELETE /appointments/:id removes the row and detail returns 404` |
| Project / tag | api / **@mutating** |
| Type | Functional, state verification |
...
These cases are generated by the loop at [appointments.spec.ts:142](../../tests/api/appointments.spec.ts:142). They share these steps:
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:177](../../tests/api/appointments.spec.ts:177) › `Appointments API writes › POST /appointments rejects a duplicate slot and leaves exactly one booking` |
| Project / tag | api / **@mutating** |
...
| Field | Value |
|---|---|
| Automated test | [appointments.spec.ts:189](../../tests/api/appointments.spec.ts:189) › `Appointments API writes › PUT /appointments/:id/reschedule rejects an invalid body and stores no change` |
| Project / tag | api / **@mutating** |
