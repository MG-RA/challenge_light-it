...
Generated by the loop at [login.spec.ts:33](../../tests/ui/login.spec.ts:33). Type: functional, client-side validation. Priority P2. Finding: —. Last recorded: **Pass for all 3** (2026-09-13).
...
| Field | Value |
|---|---|
| Automated test | [login.spec.ts:52](../../tests/ui/login.spec.ts:52) › `login shows actionable feedback for throttling` |
| Project / tag | ui / — |
